...
#     sudo -H -u vagrant /vagrant/proxy/v2ray_install.sh
#     cp /vagrant/proxy/config.json /usr/local/etc/v2ray/config.json
...
#     export https_proxy=http://127.0.0.1:10809
    ...
    # Download bsc
     ...
     if [ ! -d ~vagrant/${BSVER} ]; then
       ...
       sudo wget -nc -nv https://github.com/B-Lang-org/bsc/releases/download/${BSREL}/${BSVER}.tar.gz
       sudo tar xzf ${BSVER}.tar.gz
